...
function UpdateCounter() {
  ...
  const decreaseValue = () => {
    counter = counter - 1;
    setCounter(counter);
    console.log("Value Decrese",counter);
  };
...
const [loggedIn, setLoggedIn] = useState(2);
  return (
    <div>
      ...
      <button onClick={decreaseValue}>decrese</button>

      <div class="flex font-sans">
        <div class="flex-none w-52 relative">
            <img src="https://images.pexels.com/photos/127428/pexels-photo-127428.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
        </div>
    ...
    <div>
        {loggedIn ==1 ?<h1>welcome ritesh</h1>:loggedIn==2?<h1>Welcome rishab</h1>:<h1> welcome Guest </h1>}
    </div>
